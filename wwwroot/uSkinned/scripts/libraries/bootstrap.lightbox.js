        ...
        createCarousel() {
            const t = document.createElement("template"),
                ...
                s = this.sources.map(((t, s) => {
                    ...
                    // Only render caption if it has content
                    if (caption && caption.trim() !== "") {
                        r = '<div class="lightbox-caption text-center p-2 position-absolute top-100 w-100 z-3">' +
                            '<div class="text white-text"><p>' + caption + '</p></div></div>';
                    }

                    // Only render title if it has content
                    if (title && title.trim() !== "") {
                        titleDiv = '<div class="lightbox-title text-center p-2 position-absolute bottom-100 w-100 z-3">' +
                            '<p class="heading sm white-text">' + title + '</p></div>';
                    }
